...
$.ajax({
    type: 'get',
    url: '/venue/get_venue_statistics',
    async: false,
    dataType: 'json',
    success: function (data) {
        ...
        var myChart = echarts.init(document.getElementById('right-content-graph'));
        option = {
            title : {
                text: '场馆订票数据统计'
            },
            ...
            yAxis: [
                {
                    ...
                    min: countMin,
                    max: countMax,
                    interval: parseInt((countMax-countMin)/10)+1,
                    axisLabel: {
                        formatter: '{value} 张'
                    }
                },
                {
                    ...
                    min: consumptionMin,
                    max: consumptionMax,
                    interval: parseInt((consumptionMax-consumptionMin)/10),
                    axisLabel: {
                        formatter: '{value} 元'
                    }
                }
...
// $.ajax({
//     type: 'get',
//     url: '/venue/get_now_venue',
//     async: false,
//     dataType: 'json',
//     success: function (data) {
//         document.getElementById("right-content-venuename").innerHTML = data.information;
//     },
//     error: function () {
//         alert("error");
//     }
