...
<head>
    ...
    <link rel="stylesheet" href="../../css/admin/adminsettleaccount.css">
    <!--[if lt IE 9]>
    ...
    <div class="row">
        ...
        <div class="navigation-right-whole">
            <div id="right-top-bar">
                <div id="right-top-1"><a class="top-a" href="#">场馆利润结算</a></div>
            </div>
            <%--这里是分页list，还未完成--%>
            <div>
                <div class="list-content">
                    <table class="table" id="list-table">
                        <thead>
                        <tr>
                            <th class="top-address">场馆</th>
                            <th class="top-planname">演出名称</th>
                            <th class="top-sale">销售额</th>
                            <th class="top-operation">操作</th>
                        </tr>
                        </thead>
                        <tbody>
                        </tbody>
...
<script src="../../js/admin/adminsettleaccount.js"></script>
</body>
</html>
