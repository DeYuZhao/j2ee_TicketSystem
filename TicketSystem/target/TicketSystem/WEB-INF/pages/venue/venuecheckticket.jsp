...
<head>
    ...
    <link rel="stylesheet" href="../../css/venue/venuecheckticket.css">
    <!--[if lt IE 9]>
                ...
                <div class="container">
                    <div class="demo clearfix">
                        ...
                        <div class="booking_area">
                            ...
                            <div id="sure"><a id="sureid" href="" onclick="getSelectedSeat()">通过检票</a></div>
...
<script src="../../js/venue/venuecheckticket.js"></script>
</body>
</html>
