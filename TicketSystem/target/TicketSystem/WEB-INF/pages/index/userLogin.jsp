                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                            		...
                            		<p>Enter your email and password to log in:
                                        <a id="codebutton" style="margin-left: 217px" href="#" onclick="sendCode()" class="button button-glow button-border button-rounded button-primary">发送验证码</a>
                                    </p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="" method="post" class="login-form">
                                    ...
                                    <a id="logintojsp" onclick="login()" href="" class="button button-glow button-rounded button-raised button-primary">登录</a>
