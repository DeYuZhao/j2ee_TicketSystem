...
<head>
    ...
    <link rel="stylesheet" href="../../css/venue/venueticketlist.css">
    <!--[if lt IE 9]>
        ...
        <div class="navigation-right-whole">
            <div class="row">
                <table class="table table-bordered" id="list-table">
                    <thead>
                    <tr><th id="planth">演出计划</th><th id="ticketcheck">检票</th><th id="ticketsell">售票</th></tr>
                    </thead>
                    <tbody>
                    </tbody>
                </table>
...
<script src="../../js/venue/venueticketlist.js"></script>
</body>
</html>
