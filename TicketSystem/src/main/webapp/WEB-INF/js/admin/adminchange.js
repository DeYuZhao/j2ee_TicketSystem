...
function getInfoList(start,size) {
    ...
    function chi(m) {
        ...
        e.onclick = function () {
            checkVenueChangeInfo(addressarray[m],linkidarray[m]);
        }
    }
}
function checkVenueChangeInfo(address,linkid) {
    $.ajax({
        type:'post',
        ...
        success:function (data) {
            document.getElementById(linkid).href = "/admin/admincheckchange";
        },
        error:function () {
            alert("error");
        }
