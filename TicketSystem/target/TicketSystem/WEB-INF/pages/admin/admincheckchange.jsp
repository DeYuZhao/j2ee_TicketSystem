...
<head>
    ...
    <link rel="stylesheet" href="../../css/admin/admincheckchange.css">
    <!--[if lt IE 9]>
        ...
        <div class="navigation-right-whole">
            ...
            <div class="form-bottom">
                <form role="form" action="" method="post" class="login-form">
                    ...
                    <a id="registertojsp" href="/admin/adminchangelist" onclick="pass()" class="button button-glow button-rounded button-raised button-primary">通过</a>
                    <a id="ulcancel" href="/admin/adminchangelist" onclick="notpass()" class="button button-glow button-rounded button-raised button-primary">不通过</a>
                </form>
            </div>
        </div>
    </div>
